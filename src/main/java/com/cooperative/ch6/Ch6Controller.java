...
public class Ch6Controller {
    ...
    @ResponseBody
    public String findUser(int userId) throws JsonProcessingException {
    ...
    @ResponseBody
    public String alluser(int page, int size) throws JsonProcessingException {
    ...
    public @ResponseBody
    String getDepartmentUser(String name, Integer deptId) throws JsonProcessingException {
    ...
    public @ResponseBody
    String pageQuery(Integer deptId, int page, int size) throws JsonProcessingException {
...
//		Page<User> users =  userService.queryUser(deptId, pr);
    ...
    public @ResponseBody
    String example(String name) throws JsonProcessingException {
    ...
    public @ResponseBody
    String updateUser(String name, Integer id) {
        int result = userService.updateUser(name, id);
